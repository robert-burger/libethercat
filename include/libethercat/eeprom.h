 ...
 * \retval  EC_ERROR_EEPROM_CHECKSUM            EEPROM checksum is wrong.
 */
int ec_eepromread_len(struct ec* pec, osal_uint16_t slave, osal_uint32_t eepadr, osal_uint8_t* buf,
                      osal_size_t buflen);
 ...
 * \retval  EC_ERROR_EEPROM_CHECKSUM            EEPROM checksum is wrong.
 */
int ec_eepromwrite_len(struct ec* pec, osal_uint16_t slave, osal_uint32_t eepadr,
