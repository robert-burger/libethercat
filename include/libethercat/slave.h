 ...
 * \return EC_OK on success, otherwise EC_ERROR_* code.
 */
int ec_slave_get_state(struct ec* pec, osal_uint16_t slave, ec_state_t* state,
 ...
 */
void ec_slave_set_dc_config(struct ec* pec, osal_uint16_t slave, int use_dc, int type,
